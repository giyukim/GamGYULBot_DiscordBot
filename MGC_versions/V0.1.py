...
answer = ['Maybe someday', 'Nothing', 'Neither', 'I don\'t think so', 'Yes', 'Try asking again', 'No', '언젠가는 하겠죠', '가만있어요', '다 안 돼요', '그것도 안 돼요', '좋아요', '다시 한 번 물어봐요', '안 돼요', '언젠가는', '가만히 있어', '둘 다 먹지 마', '그것도 안 돼', '그럼', '다시 한 번 물어봐', '안 돼']
    ...
    if msg[0] != '마법의감귤고둥님':
        ...
        if len(msg) == 1:
            ...
            if msg[1] == '도움말': #마법의감귤고둥님 도움말
                embed = discord.Embed(title=":tangerine: 도움말 :tangerine:", description="마법의 감귤고둥 V0.1B \n개발자: 감귤 \n문의: 감귤#1936 1jgg1020@gmail.com \n접두어: '마법의감귤고둥님 '", color=0xffa600)
