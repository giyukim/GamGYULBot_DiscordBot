...
statcomm = ['핑', '도움말', '청소', '김태균', '감귤', '귤', '귤아', '배워', '[질문]', '데이터베이스', '금지', '웹페이지', '디스코드', '주사위', '골라줘']
...
async def on_message(message):
    ...
    if msg[0] == '귤아':
        ...
        if len(msg) == 1: #귤아
            ...
            if msg[1] == '도움말': #귤아 도움말
                embed = discord.Embed(title=":tangerine: 도움말 :tangerine:", description="감귤봇 V1.0.6 \n개발자: 감귤 \n문의: 감귤#1936 1jgg1020@gmail.com \n접두어: '귤아 '", color=0xffa600)
                ...
                embed.add_field(name="대화", value="배워, [질문]", inline=True)
